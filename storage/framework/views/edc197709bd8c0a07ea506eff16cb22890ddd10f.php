                ...
                <div class="col-12 col-md-3 col-right">
                    <div class="frame recommendations">
                        ...
                        <div class="follow-it teacher d-none">
                            <a href="" class="logo-thumb"><img src="<?php echo e(asset('css/img/teacher-03.jpg')); ?>" alt=""><h4>Rubie Rueda</h4></a>
                            <a href="" class="btn btn-sm btn-outline-primary">Follow</a>
                        </div>
                        <div class="follow-it teacher d-none">
                            <a href="" class="logo-thumb"><img src="<?php echo e(asset('css/img/teacher-02.jpg')); ?>" alt=""><h4>Terry Stever</h4></a>
                            <a href="" class="btn btn-sm btn-outline-primary">Follow</a>
                        </div>
                        <div class="footer">
                            <a href="<?php echo e(url('/about')); ?>">About</a> <span>·</span>
                            <a href="<?php echo e(url('/help')); ?>">Help Center</a> <span>·</span>
                            <a href="<?php echo e(url('/privacy')); ?>">Privacy Policy</a> <span>·</span>
                            <a href="<?php echo e(url('/terms')); ?>">Term &amp; Conditions</a> <span>·</span>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/es/resources/views/news_feed.blade.php ENDPATH**/ ?>