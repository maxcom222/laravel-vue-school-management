...
<main class="authorize register">
  ...
  <div class="user-box"> <input type="hidden" id="login_page" value="1" /><a href=""><img src="<?php echo e(asset('css/img/logoa.png')); ?>" alt="Expats' Schools Logo"></a>
        ...
        <form id="login_form">
          <div class="form-group row">
            ...
            <div class="col-12 col-sm-6  d-none">
              ...
              <use xlink:href="<?php echo e(asset('js/plugins/menu/symbol-defs.svg')); ?>#icon-facebook"></use>
              </svg> Login with facebook</button>
            </div>
            <div class="col-12 col-sm-6 d-none">
              <button type="button" class="btn btn-gogl js_google_login"><svg class="icon icon-google-plus">
              <use xlink:href="<?php echo e(asset('js/plugins/menu/symbol-defs.svg')); ?>#icon-google-plus"></use>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/es/resources/views/login.blade.php ENDPATH**/ ?>