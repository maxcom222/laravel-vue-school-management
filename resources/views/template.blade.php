...
<meta name="csrf-token" content="{{ csrf_token() }}" />
    ...
    <link href="{{ asset('js/plugins/bootstrap/bootstrap.min.css') }}" rel="stylesheet">

    <link rel="stylesheet" href="{{ asset('js/plugins/owl.css') }}">
    ...
    <link rel="shortcut icon" href="{{ asset('css/img/favicon.ico') }}">



  @if (  $page  ==  'main' || $page == 'single_main' )
  ...
  @if (  $page  ==  'login' ||  $page == 'teachers/profile_wizard'  )
...
@endif
  ...
  @if (  $page  ==  'classified/place_ad' ||  $page == 'classified/edit_place_ad' )
...
@if (  $page  ==  'classified/detail' )
<link href="{{ asset('css/plugins/dropzone.min.css') }}" rel="stylesheet" />

@endif

@if (  $page  ==  'teachers/profile_wizard' )
<link href="{{ asset('css/profile_wizard.css') }}" rel="stylesheet" />
@endif
...
@if (  $page  ==  'teachers/profile_teacher' || $page == 'teachers/profile_public_teacher' )
<link href="{{ asset('css/select2.min.css') }}" rel="stylesheet" />
<link href="{{ asset('css/plugins/dropzone.min.css') }}" rel="stylesheet" />
<link href="{{ asset('css/profile_teachers.css') }}" rel="stylesheet" />
@endif


    @if (  $page  ==  'coffe_club/staff_room'   ||   $page  ==  'coffe_club/forum_detail')
  ...
  @if (  $page  ==  'friends' ||  $page  ==  'single_main'   )
...
@if (  $page  ==  'coffe_club/forum_detail' || $page == 'schools/job_detail' || $page == 'jobs/job_detail' || $page == 'classified/detail' || $page == 'schools/school_albums'   )
...
<body fullPath="{{ url('/') }}" ><div id="fb-root"></div>
