        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <a href=""><img src="{{ asset('css/img/logo-footera.png') }}" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-3 d-none">
                    ...
                    <ul>
                      	 ...
                      	 <li><a href="{{ url('city/dubai') }}">Dubai</a></li>
                      	 <li><a href="{{ url('city/abudhabi') }}">Abu Dhabi (coming soon)</a></li>
                       	 <li><a href="{{ url('city/hongkong') }}">Hong Kong (coming soon)</a></li>
                         <li><a href="{{ url('city/singapore') }}">Singapore (coming soon)</a></li>
                         <li><a href="{{ url('city/beijing') }}">Beijing (coming soon)</a></li>
                ...
                <div class="col-12 col-md-6 col-lg-3  d-none">
                    <h4>Top Schools</h4>
                    <ul>
                        <li><a href="{{ url('/school/jumeirah-english-speaking-school-1538370119') }}">Jumeirah English Speaking School</a>
                        </li><li><a href="{{ url('/school/ranches-primary-school-1538734489') }}">Ranches Primary School</a></li>
                        <li><a href="{{ url('/school/foremarke-school-1538383838') }}">Foremarke School</a></li>
                        
                         <li><a href="{{ url('/school/dubai-college') }}">Dubai College</a></li>
                    </ul>
                </div>
            </div>
            <div class="row">
