                ...
                <div class="tab-pane fade show active" id="pills-step-1" role="tabpanel">
                    ...
                    <form>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <input type="text" value="" class="form-control" id="ad_title" name="ad_title" placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row level_5 d-none">
                            ...
                            <div class="col-12">
                                 ...
                                 <?php for( $i = 1970; $i <= date('Y'); $i++ ) {  $sel = '';   if( $i == 2015 ){ $sel = 'selected'; }  ?>
                        ...
                        <div class="form-group row level_5 d-none">
                            ...
                            <div class="col-12">
                                 <input  style="width:100%;" value="0"   type="range" min="0" max="1000000"  class="level_4 d-none"  id="js_mileage"  />
                                 <span id="js_mileage_span">0 KM</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row level_5 d-none">
                            ...
                            <div class="col-12">
                                 <input  class="form-control level_4 d-none"    type="checkbox"   id="service_history"  />
                            </div>
                        </div>
                        ...
                        <div class="form-group row ">
                            ...
                            <input type="text" class="form-control" autocomplete="off" id="address" name="address"  /><br /><Br />
                ...
                <div class="tab-pane fade" id="pills-step-2" role="tabpanel">
                    <p class="lead">Important details</p>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                                <textarea value="" style="height:100px;" class="form-control" id="description" name="description"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row  n-car">
                            ...
                            <div class="col-12">
                                <select  id="usage" name="usage" class="placeholder">
                                    <option value="" selected="selected">Usage</option>
                                    <option value="1">Still in original packaging</option>
                                    <option value="2">Out of original packaging, but only used once</option>
                                    <option value="3">Used only a few times</option>
                                    <option value="4">Used an average amount, as frequently as would be expected</option>
                                    <option value="5">Used an above average amount since purchased</option>
                                </select>
                            </div>
                        </div>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-12">
                                <select  id="condition" name="condition" class="placeholder">
                                    ...
                                    <option value="5">Perfect inside and out</option>
                                    <option value="4">Almost no noticeable problems or flaws</option>
                                    <option value="3">A bit of wear and tear, but in good working condition</option>
                                    <option value="2">Normal wear and tear for the age of the item, a few problems here and there</option>
                                    <option value="1">Above average wear and tear.  The item may need a bit of repair to work properly</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-12">
                               <select  id="warranty" name="warranty" class="">
                                <option value="" selected="selected" disabled="disabled">Warranty</option>
