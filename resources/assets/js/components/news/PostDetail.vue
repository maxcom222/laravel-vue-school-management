<template>
    ...
    <div>
        ...
        <main  v-if="loader!==1" class="two-cloumn coffe-club">

            <div v-if="loaderRun" class="loader"> <div class="lds-ellipsis"><div><div></div></div><div><div></div></div><div><div></div></div><div><div></div></div><div><div></div></div></div></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h2>Grow your network. Connect with awesome people</h2>
                ...
                handler: 'onClose'
                            ...
                            <div>
                                ...
                                <a @click.prevent="profileUrl" :href="profile_url" class="publisher">
                ...
                shared
                                ...
                                <h2>
                                    ...
                                    <a @click.prevent="postUrl" :href="post_url">
                            ...
                            <ul class="actions">
                                ...
                                <li>
                                    ...
                                    <a href=""  @click.prevent="likeItem"   :class="likeStatus === 'like' ? 'activity-active' : ''">

                                        <svg class="icon icon-thumb_up">
    ...
    export default {
        ...
        methods: {
            ...
            updateData(){
                ...
                let param = { url : this.$route.params.url, username: this.$route.params.username };

                axios.post( this.fullPath +'sp/get_post',  param )
                    .then( res => {
                        ...
                        this.post.id = this.post.post_id;
