        ...
        <main class=" register">
            ...
            <div class="reg-box">
                ...
                <div  v-if="mini_step === 1">
                    ...
                    <p class="lead">Register your  account as a parent or teacher.</p>

                    <p class="lead"> If you want to join the Expat Teachers Club you must be registered as a teacher.
                ...
                <transition name="slide" >
                     ...
                     <form  autocomplete="off"  v-if="mini_step !== 1"  method="post" @submit.prevent="submitRegister">
                         ...
                         <div class="form-group row" v-if="noticeModal===true">

                             <div class="col-sm-12">

                                 <p

                                         :class="noticeModal===true? 'alert alert-danger' :  ''">
                        ...
                        axios.post(this.fullPath + 'user/post/register', param  )
                            ...
                            .then( res => {
                                ...
                                if( parseInt(  data.response ) === 1 )
                                {
                                    ...
                                    this.$router.push('/profile_wizard/' + this.type )  ;

                                }
                                else if( parseInt(  data.response ) === 2 )
                                {

                                    this.noticeHeader = 'Account Registration';

                                    this.noticeMsg = 'Email address is already registered. Use new email address or reset your password.';
                                ...
                                else if( parseInt(  data.response ) === 3 )
                                {
                                    ...
                                    this.noticeMsg = 'Error found. Please try later.';
