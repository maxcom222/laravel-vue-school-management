    ...
    export default {
        ...
        methods: {
                ...
                axios.post(  this.fullPath + 'user/getfriends')
                    .then( response => {
                        ...
                        if( parseInt( response.data.result )  === 2 ){
                            ...
                            if( this.get_friend_call === true ){

                                this.get_friend_call = false;

                                this.checkBrowserParam();
                            }
            ...
            checkBrowserParam(){
                ...
                let findFriend = false;

                this.friends.forEach( friend => {


                    if( friend.id === parseInt(this.$route.params.id)   ) {
